...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.listaTareas.sizePolicy().hasHeightForWidth())
        self.listaTareas.setSizePolicy(sizePolicy2)

        self.gridLayout_2.addWidget(self.listaTareas, 1, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.botonEliminarTodo, 4, 0, 1, 2)
        ...
        self.botonNuevaTarea.setMinimumSize(QSize(16, 16))
        self.botonNuevaTarea.setMaximumSize(QSize(16777215, 27))
        self.botonNuevaTarea.setAutoFillBackground(False)

        self.gridLayout_2.addWidget(self.botonNuevaTarea, 2, 1, 1, 1)
